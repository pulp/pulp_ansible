...
def test_duplicate_collection_key(
    ...
    content_unit_1 = ansible_collection_version_api_client.read(content_unit_href1)
    assert content_unit_1.sha256 == sha256_1
    content_unit_2 = ansible_collection_version_api_client.read(content_unit_href2)
