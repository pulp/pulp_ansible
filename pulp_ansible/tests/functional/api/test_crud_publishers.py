...
from pulp_ansible.tests.functional.constants import ANSIBLE_PUBLISHER_PATH
from pulp_ansible.tests.functional.utils import gen_ansible_publisher, skip_if
...
class CRUDPublishersTestCase(unittest.TestCase):
    ...
    def test_01_create_publisher(self):
        """Create a publisher."""
        body = gen_ansible_publisher()
        type(self).publisher = self.client.post(ANSIBLE_PUBLISHER_PATH, body)
    ...
    def test_02_create_same_name(self):
        ...
        with self.assertRaises(HTTPError):
            self.client.post(ANSIBLE_PUBLISHER_PATH, body)
    ...
    def test_02_read_publishers(self):
        ...
        page = self.client.get(ANSIBLE_PUBLISHER_PATH, params={
