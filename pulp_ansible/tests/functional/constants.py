...
NAMESPACE_DOCKER = "?namespace_name=geerlingguy"
...
ANSIBLE_DOCKER_ROLE_REPO = "ansible-role-docker"

ANSIBLE_DOCKER_ROLE_NAMESPACE_NAME = f"{ANSIBLE_DOCKER_ROLE_NAMESPACE}.{ANSIBLE_DOCKER_ROLE_NAME}"

ANSIBLE_DOCKER_ROLE = "{ANSIBLE_DOCKER_ROLE_NAMESPACE_NAME},2.1.0"

ANSIBLE_DOCKER_FIXTURE_URL = urljoin(ANSIBLE_GALAXY_URL, NAMESPACE_DOCKER)
