...
ANSIBLE_COLLECTION_FIXTURE_URL_V2 = urljoin(ANSIBLE_GALAXY_COLLECTION_URL_V2, NAMESPACE_TESTING)

ANSIBLE_COLLECTION_TESTING_URL_V2 = urljoin(
    ANSIBLE_GALAXY_COLLECTION_URL_V2, COLLECTION_WHITELIST.replace(".", "/")
)
...
ANSIBLE_COLLECTION_TESTING_URL_V3 = urljoin(
    ANSIBLE_GALAXY_COLLECTION_URL_V3, COLLECTION_WHITELIST.replace(".", "/")
)
