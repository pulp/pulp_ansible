    ...
    DEFAULT_ACCESS_POLICY = {
        "statements": [
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_or_domain_or_perms:ansible.add_roleremote",
            },
            {
                "action": "destroy",
                "principal": "authenticated",
    ...
    DEFAULT_ACCESS_POLICY = {
        "statements": [
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_or_domain_or_obj_perms:ansible.manage_roles_ansiblerepository",
            },
        ],
        "creation_hooks": [
            {
        ...
        "statements": [
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_repository_model_or_domain_or_obj_perms:ansible.view_ansiblerepository",
            },
            {
                "action": "destroy",
                "principal": "authenticated",
            ...
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_repository_model_or_domain_or_obj_perms:ansible.rebuild_metadata_ansiblerepository",
                ],
            },
        ],
    }
    ...
    DEFAULT_ACCESS_POLICY = {
        "statements": [
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_or_domain_or_obj_perms:ansible.manage_roles_collectionremote",
            },
        ],
        "creation_hooks": [
            {
        ...
        "statements": [
            ...
            },
            {
                ...
                "condition": [
                    ...
                    "has_repo_or_repo_ver_param_model_or_domain_or_obj_perms:ansible.view_ansiblerepository",
                ],
            },
            {
                "action": "destroy",
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_or_domain_or_obj_perms:ansible.manage_roles_ansibledistribution",
            },
        ],
        "creation_hooks": [
            {
